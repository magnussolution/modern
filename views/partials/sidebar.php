    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="/index.php/provider/index">
                        <i class="las la-flask"></i> <span data-key="t-widgets">Provider</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="/">
                        <i class="las la-flask"></i> <span data-key="t-widgets">Velzon</span>
                    </a>
                </li>
