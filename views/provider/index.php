...
<body>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0">
                                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-10.jpg" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">
                                                                </div>
                                                                    ...
                                                                    <div class="position-relative d-inline-block">
                                                                        ...
                                                                        <div class="avatar-lg p-1">
                                                                            <div class="avatar-title bg-light rounded-circle">
                                                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/users/user-dummy-img.jpg" id="lead-img" class="avatar-md rounded-circle object-fit-cover" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
    ...
    <!-- crm leads init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/crm-leads.init.js"></script>
