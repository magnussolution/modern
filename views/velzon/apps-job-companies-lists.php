...
<body>
                                ...
                                <div class="card-body">
                                    <div class="avatar-lg mx-auto mb-3">
                                        <div class="avatar-title bg-light rounded">
                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/companies/img-6.png" alt="" class="avatar-sm company-logo">
                                        </div>
                                    </div>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/job-companies-lists.init.js"></script>
