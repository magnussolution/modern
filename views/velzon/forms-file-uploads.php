...
<body>
                                                ...
                                                <div class="d-flex p-2">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar-sm bg-light rounded">
                                                            <img data-dz-thumbnail class="img-fluid rounded d-block" src="<?= Yii::$app->request->baseUrl ?>//images/new-document.png" alt="Dropzone-Image" />
                                                        </div>
                                                    </div>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/form-file-upload.init.js"></script>
