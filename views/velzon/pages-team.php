...
<body>
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="px-1 pt-1">
                                                                <div class="modal-team-cover position-relative mb-0 mt-n4 mx-n4 rounded-top overflow-hidden">
                                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/small/img-9.jpg" alt="" id="cover-img" class="img-fluid">
                                                                ...
                                                                <div class="position-relative d-inline-block">
                                                                    ...
                                                                    <div class="avatar-lg">
                                                                        <div class="avatar-title bg-light rounded-circle">
                                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/users/user-dummy-img.jpg" id="member-img" class="avatar-md rounded-circle h-auto" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
    ...
    <!-- team init js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/team.init.js"></script>
