...
<head>
    ...
    <!-- multi.js css -->
    <link rel="stylesheet" type="text/css" href="<?= Yii::$app->request->baseUrl ?>//libs/multi.js/multi.min.css" />
    <!-- autocomplete css -->
    <link rel="stylesheet" href="<?= Yii::$app->request->baseUrl ?>//libs/@tarekraafat/autocomplete.js/css/autoComplete.css">
...
<body>
                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                ...
                                                <div class="input-group" data-input-flag>
                                                    <button class="btn btn-light border" type="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="<?= Yii::$app->request->baseUrl ?>//images/flags/us.svg" alt="flag img" height="20" class="country-flagimg rounded"><span class="ms-2 country-codeno">+ 1</span></button>
    ...
    <!-- multi.js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/multi.js/multi.min.js"></script>
    <!-- autocomplete js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/@tarekraafat/autocomplete.js/autoComplete.min.js"></script>

    <!-- init js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/form-advanced.init.js"></script>
    <!-- input spin init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/form-input-spin.init.js"></script>
    <!-- input flag init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/flag-input.init.js"></script>
