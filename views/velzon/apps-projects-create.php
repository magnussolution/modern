...
<head>
    ...
    <!-- Plugins css -->
    <link href="<?= Yii::$app->request->baseUrl ?>//libs/dropzone/dropzone.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <!-- dropzone js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/dropzone/dropzone-min.js"></script>
    <!-- project-create init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/project-create.init.js"></script>
