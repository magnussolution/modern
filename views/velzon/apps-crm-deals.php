...
<head>
    ...
    <!-- Sweet Alert css-->
    <link href="<?= Yii::$app->request->baseUrl ?>//libs/sweetalert2/sweetalert2.min.css" rel="stylesheet" type="text/css" />
...
<body>
                                ...
                                <div class="card mb-1">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated2" role="button" aria-expanded="false" aria-controls="contactInitiated2">
                                            <div class="flex-shrink-0">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/github.png" alt="" class="avatar-xs rounded-circle" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated5" role="button" aria-expanded="false" aria-controls="contactInitiated5">
                                            <div class="flex-shrink-0">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/mail_chimp.png" alt="" class="avatar-xs rounded-circle" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card mb-1">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified3" role="button" aria-expanded="false" aria-controls="needsIdentified3">
                                            <div class="flex-shrink-0">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/dribbble.png" alt="" class="avatar-xs rounded-circle" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card mb-1">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified6" role="button" aria-expanded="false" aria-controls="needsIdentified6">
                                            <div class="flex-shrink-0">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/companies/img-6.png" alt="" class="avatar-xs rounded-circle" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card mb-1">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged1" role="button" aria-expanded="false" aria-controls="meetingArranged1">
                                            <div class="flex-shrink-0">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/companies/img-5.png" alt="" class="avatar-xs rounded-circle" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged3" role="button" aria-expanded="false" aria-controls="meetingArranged3">
                                            <div class="flex-shrink-0">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/companies/img-8.png" alt="" class="avatar-xs rounded-circle" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                                    ...
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted2" role="button" aria-expanded="false" aria-controls="offerAccepted2">
                                            <div class="flex-shrink-0">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/slack.png" alt="" class="avatar-xs rounded-circle" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                                    ...
                                    <div class="card-body">
                                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted5" role="button" aria-expanded="false" aria-controls="offerAccepted5">
                                            <div class="flex-shrink-0">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/companies/img-3.png" alt="" class="avatar-xs rounded-circle" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
    ...
    <!-- cleave.js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/cleave.js/cleave.min.js"></script>

    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/crm-deals.init.js"></script>

    <!-- Sweet Alerts js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/sweetalert2/sweetalert2.min.js"></script>
