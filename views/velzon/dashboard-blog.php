...
<head>
    ...
    <?php echo $this->render('../partials/title-meta', array('title' => 'Blog')); ?>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('../partials/page-title', array('pagetitle' => 'Dashboards', 'title' => 'Blog')); ?>
                                    ...
                                    <div data-simplebar class="mx-n3 px-3" style="height: 375px;">
                                        <div class="vstack gap-3">
                                            <div class="d-flex gap-3">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-3.jpg" alt="" class="avatar-sm rounded flex-shrink-0">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-5.jpg" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-6.jpg" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-7.jpg" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-9.jpg" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-10.jpg" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-2.jpg" alt="" class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                        ...
                                        <table class="table table-hover table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>01</td>
                                                    <td>
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/blog/img-2.jpg" alt="" class="me-2 rounded" height="40">
                                                ...
                                                <tr>
                                                    <td>02</td>
                                                    <td>
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/blog/img-3.jpg" alt="" class="me-2 rounded" height="40">
                                                ...
                                                <tr>
                                                    <td>03</td>
                                                    <td>
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/blog/img-4.jpg" alt="" class="me-2 rounded" height="40">
                                                ...
                                                <tr>
                                                    <td>04</td>
                                                    <td>
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/blog/img-5.jpg" alt="" class="me-2 rounded" height="40">
                                                ...
                                                <tr>
                                                    <td>05</td>
                                                    <td>
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/blog/img-6.jpg" alt="" class="me-2 rounded" height="40">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-1.jpg" alt="" class="avatar-sm rounded-circle img-thumbnail">
                                                </div>
                                                <div class="flex-grow-1">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
    ...
    <!-- Dashboard init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/dashboard-blog.init.js"></script>
