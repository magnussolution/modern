...
<body>
                                            ...
                                            <div class="product-img-slider sticky-side-div">
                                                <div class="swiper product-thumbnail-slider p-2 rounded bg-light">
                                                    <div class="swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/products/img-6.png" alt="" class="img-fluid d-block" />
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/products/img-1.png" alt="" class="img-fluid d-block" />
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/products/img-8.png" alt="" class="img-fluid d-block" />
                                                        </div>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/ecommerce-product-details.init.js"></script>
