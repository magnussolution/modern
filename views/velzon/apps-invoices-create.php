...
<head>
    ...
    <!-- dropzone css -->
    <link rel="stylesheet" href="<?= Yii::$app->request->baseUrl ?>//libs/dropzone/dropzone.css" type="text/css" />
...
<body>
                                                ...
                                                <div class="profile-user mx-auto  mb-3">
                                                    ...
                                                    <label for="profile-img-file-input" class="d-block" tabindex="0">
                                                        <span class="overflow-hidden border border-dashed d-flex align-items-center justify-content-center rounded" style="height: 60px; width: 256px;">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/logo-dark.png" class="card-logo card-logo-dark user-profile-image img-fluid" alt="logo dark">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/logo-light.png" class="card-logo card-logo-light user-profile-image img-fluid" alt="logo light">
                                                        </span>
                                                    </label>
                                                </div>
                                                <div>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/invoicecreate.init.js"></script>
