...
<body>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6">
                                            <div class="text-center">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/illustrator-1.png" class="img-fluid" alt="">
                                            </div>
                                        </div><!-- end col -->
                                    </div><!-- end row -->
                                    <div class="mt-3 pt-2">
    ...
    <!-- Dashboard init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/dashboard-analytics.init.js"></script>
