...
<body>
                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                <div class="d-flex align-items-center">
                                                                    <div class="flex-shrink-0 chat-user-img online user-own-img align-self-center me-3 ms-0">
                                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-2.jpg" class="rounded-circle avatar-xs" alt="">
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="userProfileCanvasExample">
        ...
        <div class="offcanvas-body profile-offcanvas p-0">
            ...
            <div class="p-3 text-center">
                <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-2.jpg" alt="" class="avatar-lg img-thumbnail rounded-circle mx-auto profile-img">
                <div class="mt-3">
    ...
    <!-- fgEmojiPicker js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/fg-emoji-picker/fgEmojiPicker.js"></script>

    <!-- chat init js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/chat.init.js"></script>
