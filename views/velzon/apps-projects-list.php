...
<body>
                                            ...
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar-sm">
                                                    <span class="avatar-title bg-warning-subtle rounded p-2">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/slack.png" alt=""
                                                            class="img-fluid p-1">
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar-sm">
                                                    <span class="avatar-title bg-danger-subtle rounded p-2">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/dribbble.png" alt=""
                                                            class="img-fluid p-1">
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="avatar-group">
                                                ...
                                                <a href="javascript: void(0);" class="avatar-group-item"
                                                    ...
                                                    <div class="avatar-xxs">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-4.jpg" alt=""
                                                            class="rounded-circle img-fluid">
                                                    </div>
                                                </a>
                                                <a href="javascript: void(0);" class="avatar-group-item"
                                            ...
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar-sm">
                                                    <span class="avatar-title bg-success-subtle rounded p-2">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/mail_chimp.png" alt=""
                                                            class="img-fluid p-1">
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar-sm">
                                                    <span class="avatar-title bg-info-subtle rounded p-2">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/dropbox.png" alt=""
                                                            class="img-fluid p-1">
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center mt-3">
                                            ...
                                            <div class="avatar-group">
                                                ...
                                                <a href="javascript: void(0);" class="avatar-group-item"
                                                    ...
                                                    <div class="avatar-xxs">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-6.jpg" alt=""
                                                            class="rounded-circle img-fluid">
                                                    </div>
                                                </a>
                                                <a href="javascript: void(0);" class="avatar-group-item"
                                        ...
                                        <div class="d-flex align-items-center mt-3">
                                            ...
                                            <div class="avatar-group">
                                                <a href="javascript: void(0);" class="avatar-group-item"
                                                    ...
                                                    <div class="avatar-xxs">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-7.jpg" alt=""
                                                            class="rounded-circle img-fluid">
                                                    </div>
                                                </a>
                                                <a href="javascript: void(0);" class="avatar-group-item"
                                                    ...
                                                    <div class="avatar-xxs">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-8.jpg" alt=""
                                                            class="rounded-circle img-fluid">
                                                    </div>
                                                </a>
                                                <a href="javascript: void(0);" class="avatar-group-item"
                                ...
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-secondary-subtle rounded-top">
                                        ...
                                        <div class="text-center pb-3">
                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/dribbble.png" alt="" height="32">
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-light rounded-top">
                                        ...
                                        <div class="text-center pb-3">
                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/slack.png" alt="" height="32">
                                        </div>
                                    </div>
                                    <div class="py-3">
                                        ...
                                        <div class="d-flex align-items-center mt-3">
                                            ...
                                            <div class="avatar-group">
                                                <a href="javascript: void(0);" class="avatar-group-item"
                                                    ...
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-9.jpg" alt=""
                                                        class="rounded-circle avatar-xxs">
                                                </a>
                                                <a href="javascript: void(0);" class="avatar-group-item"
                                                    data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                    data-bs-placement="top" title="James Clem">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-10.jpg" alt=""
                                                        class="rounded-circle avatar-xxs">
                                                </a>
                                                <a href="javascript: void(0);" class="avatar-group-item"
                                                    data-bs-toggle="tooltip" data-bs-trigger="hover"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-primary-subtle rounded-top">
                                        ...
                                        <div class="text-center pb-3">
                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/dropbox.png" alt="" height="32">
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-3 mt-n3 mx-n3 bg-danger-subtle rounded-top">
                                        ...
                                        <div class="text-center pb-3">
                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/mail_chimp.png" alt="" height="32">
                                        </div>
                                    </div>
    ...
    <!-- project list init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/project-list.init.js"></script>
