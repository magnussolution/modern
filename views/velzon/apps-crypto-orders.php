...
<body>
                                            ...
                                            <tbody class="list form-check-all">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/mkr.svg" alt="" class="avatar-xxs" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/yfi.svg" alt="" class="avatar-xxs" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/mln.svg" alt="" class="avatar-xxs" />
                                                            </div>
    ...
    <!--crypto-orders init-->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/crypto-orders.init.js"></script>
