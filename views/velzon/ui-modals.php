...
<code>&lt;div class=&quot;modal-dialog modal-dialog-bottom-right&quot;&gt;...&lt;/div&gt;</code></pre>
                                    ...
                                    <div class="card text-center border">
                                        <div class="card-body p-4 pb-0">
                                            ...
                                            <div class="row justify-content-center mt-2">
                                                <div class="col-lg-10">
                                                    <div>
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/modals/success-payment.png" alt="Mac Image" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end card body -->
                                    ...
                                    <div class="card text-center border">
                                        <div class="card-body p-4 pb-0">
                                            ...
                                            <div class="row justify-content-center mt-2">
                                                <div class="col-lg-10">
                                                    <div>
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/modals/login.png" alt="Mac Image" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end card body -->
                                    ...
                                    <div class="card text-center border">
                                        <div class="card-body p-4 pb-0">
                                            ...
                                            <div class="row justify-content-center mt-2">
                                                <div class="col-lg-10">
                                                    <div>
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/modals/subscribe.png" alt="Mac Image" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end card body -->
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <div class="subscribe-modals-cover h-100">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/auth-one-bg.jpg" alt="" class="h-100 w-100 object-fit-cover" style="clip-path: polygon(100% 0%, 100% 100%, 100% 100%, 0% 100%, 25% 50%, 0% 0%);">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- /.modal-content -->
                                    ...
                                    <div class="card text-center border">
                                        <div class="card-body p-4 pb-0">
                                            ...
                                            <div class="row justify-content-center mt-2">
                                                <div class="col-lg-10">
                                                    <div>
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/modals/signup.png" alt="Mac Image" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end card body -->
    ...
    <!-- Modal Js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/modal.init.js"></script>
