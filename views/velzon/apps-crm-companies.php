...
<body>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0">
                                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/dribbble.png" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">
                                                                </div>
                                                                    ...
                                                                    <div class="position-relative d-inline-block">
                                                                        ...
                                                                        <div class="avatar-lg p-1">
                                                                            <div class="avatar-title bg-light rounded-circle">
                                                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/users/multi-user.jpg" id="companylogo-img" class="avatar-md rounded-circle object-fit-cover" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                            ...
                            <div class="card" id="company-view-detail">
                                <div class="card-body text-center">
                                    <div class="position-relative d-inline-block">
                                        <div class="avatar-md">
                                            <div class="avatar-title bg-light rounded-circle">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/mail_chimp.png" alt="" class="avatar-sm rounded-circle object-fit-cover">
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/crm-companies.init.js"></script>
    <!-- App js -->
