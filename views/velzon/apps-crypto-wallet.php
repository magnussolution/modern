...
<body>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/eth.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/xmr.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/mkr.svg" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                                        ...
                                        <table class="table align-middle table-nowrap" id="customerTable">
                                            ...
                                            <tbody class="list form-check-all">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-medium">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/btc.svg" alt="" class="avatar-xxs me-2" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-medium">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/eth.svg" alt="" class="avatar-xxs me-2" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-medium">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/xrp.svg" alt="" class="avatar-xxs me-2" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-medium">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/xmr.svg" alt="" class="avatar-xxs me-2" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-medium">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/ltc.svg" alt="" class="avatar-xxs me-2" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-medium">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/aave.svg" alt="" class="avatar-xxs me-2" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-medium">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/mkr.svg" alt="" class="avatar-xxs me-2" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center fw-medium">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/yfi.svg" alt="" class="avatar-xxs me-2" />
                        ...
                        <div class="col-xxl-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0">
                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/xmr.svg" alt="" class="avatar-xxs" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0">
                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/fil.svg" alt="" class="avatar-xxs" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mb-3">
                                        <div class="flex-shrink-0">
                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/dot.svg" alt="" class="avatar-xxs" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
    ...
    <!-- list.js min js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/list.js/list.min.js"></script>
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/list.pagination.js/list.pagination.min.js"></script>
    ...
    <!-- crypto-wallet init-->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/crypto-wallet.init.js"></script>
