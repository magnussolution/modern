...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-3">
                            <div class="card job-list-view-card overflow-hidden" id="job-overview">
                                <img src="<?= Yii::$app->request->baseUrl ?>//images/small/img-10.jpg" alt="" id="cover-img" class="img-fluid background object-fit-cover">
                                <div class="card-body">
                                    <div class="avatar-md mt-n5">
                                        <div class="avatar-title bg-light rounded-circle">
                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/companies/img-7.png" alt="" class="avatar-xs view-companylogo">
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="px-1 pt-1">
                                            <div class="modal-team-cover position-relative mb-0 mt-n4 mx-n4 rounded-top overflow-hidden">
                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/small/img-9.jpg" alt="" id="modal-cover-img" class="img-fluid">
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/job-list.init.js"></script>
