...
<body>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="company">
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0">
                                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/brands/slack.png" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">
                                                                </div>
                                                            ...
                                                            <div class="position-relative d-inline-block">
                                                                ...
                                                                <div class="avatar-lg p-1">
                                                                    <div class="avatar-title bg-light rounded-circle">
                                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/users/multi-user.jpg" id="companylogo-img" class="avatar-md h-auto rounded-circle object-fit-cover" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/job-application.init.js"></script>
