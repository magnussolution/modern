...
<head>
    ...
    <?php echo $this->render('../partials/title-meta', array('title' => 'List View')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo $this->render('../partials/page-title', array('pagetitle' => 'Blogs', 'title' => 'List View')); ?>
                                    ...
                                    <div class="mt-4 pt-4 border-top border-dashed border-bottom-0 border-start-0 border-end-0">
                                        ...
                                        <div class="list-group list-group-flush">
                                            ...
                                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-3">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/small/img-7.jpg" alt="" class="avatar-md h-auto d-block rounded">
                                                    </div>
                                            ...
                                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-3">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/small/img-4.jpg" alt="" class="avatar-md h-auto d-block rounded">
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
                                            ...
                                            <a href="javascript: void(0);" class="list-group-item text-muted py-3 px-2">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-3">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/small/img-6.jpg" alt="" class="avatar-md h-auto d-block rounded">
                                                    </div>
                                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-4">
                                                <div class="col-xxl-3 col-lg-5">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/blog/img-1.jpg" alt="" class="img-fluid rounded w-100 object-fit-cover">
                                                </div><!--end col-->
                                ...
                                <div class="col-xxl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-4">
                                                <div class="col-xxl-3 col-lg-5">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/blog/img-2.jpg" alt="" class="img-fluid rounded w-100 object-fit-cover">
                                                </div><!--end col-->
                                                <div class="col-xxl-9 col-lg-7">
                                ...
                                <div class="col-xxl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-4">
                                                <div class="col-xxl-3 col-lg-5">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/blog/img-3.jpg" alt="" class="img-fluid rounded w-100 object-fit-cover">
                                                </div><!--end col-->
                                                <div class="col-xxl-9 col-lg-7">
                                ...
                                <div class="col-xxl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-4">
                                                <div class="col-xxl-3 col-lg-5">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/blog/img-4.jpg" alt="" class="img-fluid rounded w-100 object-fit-cover">
                                                </div><!--end col-->
                                                <div class="col-xxl-9 col-lg-7">
                                ...
                                <div class="col-xxl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-4">
                                                <div class="col-xxl-3 col-lg-5">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/blog/img-6.jpg" alt="" class="img-fluid rounded w-100 object-fit-cover">
                                                </div><!--end col-->
                                                <div class="col-xxl-9 col-lg-7">
