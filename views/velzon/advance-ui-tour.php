...
<head>
    ...
    <!-- shepherd.js css -->
    <link rel="stylesheet" href="<?= Yii::$app->request->baseUrl ?>//libs/shepherd.js/css/shepherd.css">
...
<body>
                                            ...
                                            <div class="col-lg-5">
                                                <div class="text-center mt-4 mb-5">
                                                    <div class="py-3 px-2 d-inline-block" id="logo-tour">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/logo-dark.png" class="card-logo card-logo-dark" alt="logo" height="17">
                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/logo-light.png" class="card-logo card-logo-light" alt="logo" height="17">
                                                    </div>
    ...
    <!-- shepherd js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/shepherd.js/js/shepherd.min.js"></script>

    <!-- tour init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/tour.init.js"></script>
