...
<body>
    ...
    <!-- calendar min js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/fullcalendar/index.global.min.js"></script>

    <!-- Calendar init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/calendar-month-grid.init.js"></script>
