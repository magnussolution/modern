                                                    ...
                                                    <div class="tab-content" id="notificationItemsTabContent4">
                                                        <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab1" role="tabpanel">
                                                            <div data-simplebar style="max-height: 300px;" class="pe-2">
                                                                ...
                                                                <div class="text-reset notification-item d-block dropdown-item">
                                                                    <div class="d-flex">
                                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-8.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                                        <div class="flex-grow-1">
                                                                            <a href="#!">
                                                                                <h6 class="mt-0 mb-1 fs-13 fw-semibold">
                                                                                    Maureen Gibson</h6>
                                                        ...
                                                        <div class="tab-pane fade py-2 ps-2" id="messages-tab1" role="tabpanel" aria-labelledby="messages-tab">
                                                            <div data-simplebar style="max-height: 300px;" class="pe-2">
                                                                ...
                                                                <div class="text-reset notification-item d-block dropdown-item">
                                                                    <div class="d-flex">
                                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-6.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                                        <div class="flex-grow-1">
                                                                            <a href="#!">
                                                                                <h6 class="mt-0 mb-1 fs-13 fw-semibold">
                                                                                    Kenneth Brown</h6>
                                                        ...
                                                        <div class="tab-pane fade p-4" id="alerts-tab1" role="tabpanel" aria-labelledby="alerts-tab">
                                                            <div class="w-25 pt-3 mx-auto">
                                                                <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/bell.svg" class="img-fluid" alt="user-pic">
                                                            </div>
