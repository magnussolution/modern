...
<body>
                                        ...
                                        <table class="table align-middle table-nowrap table-hover" id="customerTable">
                                            ...
                                            <tbody class="list form-check-all">
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/nft/img-01.jpg" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Abstract Face Painting</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/nft/img-02.jpg" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Creative Filtered Portrait</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/nft/img-04.jpg" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Robotic Body Art</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/nft/img-06.jpg" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Smillevers Crypto</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/nft/img-05.jpg" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">The Chirstoper</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/nft/img-03.jpg" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Walking On Air</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/nft/img-04.jpg" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="apps-nft-item-details" class="text-body">Highstreet IHO Part</a>
                                                        </div>
                                                    </td>
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/apps-nft-ranking.init.js"></script>
