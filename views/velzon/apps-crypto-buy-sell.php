...
<body>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            <td class="currency_name">
                                                <div class="d-flex align-items-center fw-medium">
                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/svg/crypto-icons/dot.svg" alt="" class="avatar-xxs me-2">
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/crypto-buy-sell.init.js"></script>
