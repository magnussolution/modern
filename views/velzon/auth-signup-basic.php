...
<body>
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="/" class="d-inline-block auth-logo">
                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/logo-light.png" alt="" height="20">
                                </a>
                            </div>
    ...
    <!-- validation init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/form-validation.init.js"></script>
    <!-- password create init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/passowrd-create.init.js"></script>
</body>
