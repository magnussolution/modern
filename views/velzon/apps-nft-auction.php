...
<body>
                                        ...
                                        <table class="table table-borderless align-middle">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/nft/img-03.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/nft/img-04.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="apps-nft-item-details">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/nft/img-05.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="apps-nft-item-details">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/nft/img-02.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="apps-nft-item-details">
                                        ...
                                        <table class="table table-borderless align-middle">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-1.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="#!">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-3.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="#!">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-5.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="#!">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-10.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="#!">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-8.jpg" alt="" class="avatar-sm object-fit-cover rounded-circle">
                                                            <div class="ms-2">
                                                                <a href="#!">
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/apps-nft-auction.init.js"></script>
