...
<body>
                                                ...
                                                <div>
                                                    <div class="text-center">
                                                        <div class="profile-user position-relative d-inline-block mx-auto mb-2">
                                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/users/user-dummy-img.jpg" class="rounded-circle avatar-lg img-thumbnail user-profile-image" alt="user-profile-image">
    ...
    <!-- form wizard init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/form-wizard.init.js"></script>
