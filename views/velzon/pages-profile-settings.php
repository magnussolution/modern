...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="position-relative mx-n4 mt-n4">
                        <div class="profile-wid-bg profile-setting-img">
                            <img src="<?= Yii::$app->request->baseUrl ?>//images/profile-bg.jpg" class="profile-wid-img" alt="">
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                            <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-1.jpg" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/profile-setting.init.js"></script>
