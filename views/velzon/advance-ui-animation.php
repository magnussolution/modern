...
<head>
    ...
    <!-- aos css -->
    <link rel="stylesheet" href="<?= Yii::$app->request->baseUrl ?>//libs/aos/aos.css" />
...
<body>
                                                        ...
                                                        <div class="row justify-content-center">
                                                            <div class="col-sm-10 col-lg-8">
                                                                <div data-aos="fade-up">
                                                                    <img src="<?= Yii::$app->request->baseUrl ?>//images/mac-img.png" alt="Mac Image" class="img-fluid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <!-- aos js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/aos/aos.js"></script>
    <!-- prismjs plugin -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/prismjs/prism.js"></script>
    <!-- animation init -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/animation-aos.init.js"></script>
