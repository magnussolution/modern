...
<head>
    ...
    <link rel="stylesheet" href="<?= Yii::$app->request->baseUrl ?>//libs/nouislider/nouislider.min.css">
...
<body>
    ...
    <!-- nouisliderribute js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/nouislider/nouislider.min.js"></script>
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/wnumb/wNumb.min.js"></script>

    <!-- gridjs js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//libs/gridjs/gridjs.umd.js"></script>
    <script src="https://unpkg.com/gridjs/plugins/selection/dist/selection.umd.js"></script>
    <!-- ecommerce product list -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/ecommerce-product-list.init.js"></script>
