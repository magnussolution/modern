...
<body>
                                                        ...
                                                        <li>
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="mary-gant">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-4.jpg" alt="" class="avatar-xxs rounded-circle">
                                                                    </span>
                                                        ...
                                                        <li>
                                                            <div class="form-check d-flex align-items-center">
                                                                ...
                                                                <label class="form-check-label d-flex align-items-center" for="diego-norris">
                                                                    <span class="flex-shrink-0">
                                                                        <img src="<?= Yii::$app->request->baseUrl ?>//images/users/avatar-9.jpg" alt="" class="avatar-xxs rounded-circle">
                                                                    </span>
    ...
    <!-- titcket init js -->
    <script src="<?= Yii::$app->request->baseUrl ?>//js/pages/tasks-list.init.js"></script>
